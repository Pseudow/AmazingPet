...
public class PigPet extends AbstractPet {
    private final EntityAgeable entityAgeable;

    public PigPet(Player owner, AmazingPet amazingPet) {
        super(owner, amazingPet.getCore().getPetName("PIG"), amazingPet);

        this.entityAgeable = new EntityAgeable(Reflection.getNMSClass("EntityPig"), owner.getLocation());
