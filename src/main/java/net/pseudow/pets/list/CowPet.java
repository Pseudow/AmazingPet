...
public class CowPet extends AbstractPet {
    private final EntityAgeable entityAgeable;

    public CowPet(Player owner, AmazingPet amazingPet) {
        super(owner, amazingPet.getCore().getPetName("COW"), amazingPet);

        this.entityAgeable = new EntityAgeable(Reflection.getNMSClass("EntityCow"), owner.getLocation());
