...
public class EntityLiving {
    ...
    public Object getEquipmentPacket(EnumItemSlot slot, Object itemStack) {
        ...
        } else if(Reflection.getVersion().contains("9") || Reflection.getVersion().contains("10") || Reflection.getVersion().contains("11") || Reflection.getVersion().contains("12")
                    || Reflection.getVersion().contains("13") || Reflection.getVersion().contains("14") || Reflection.getVersion().contains("15") || Reflection.getVersion().contains("16")) {
