package net.pseudow.reflection;
...
public class Reflection {
    ...
    public static Object invokeMethod(Object instance, String methodName, Object... arguments) {
        try {
            return Objects.requireNonNull(Objects.requireNonNull(getMethod(instance.getClass(), methodName, DataType.getPrimitive(arguments)))).invoke(instance, arguments);
        } catch (IllegalAccessException | InvocationTargetException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static Object invokeStaticMethod(Class<?> clazz, String methodName, Object... arguments) {
        try {
            return Objects.requireNonNull(getMethod(clazz, methodName, DataType.getPrimitive(arguments))).invoke(null, arguments);
        } catch (IllegalAccessException | InvocationTargetException e) {
            e.printStackTrace();
        }
        return null;
